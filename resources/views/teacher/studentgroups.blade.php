  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row m-2">
          ...
          <div class="col-8"></div>
          <div class="col-2">
            <a href="/teacher/{{$group_id}}/students/group"><button class="btn btn-success">Create New Group</button></a>
          </div>
      </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
                ...
                <td>@foreach(App\Models\users_groups::where('group_id', $group->id)->get() as $ugroups)
                  {{App\Models\User::where('id', $ugroups->user_id)->get()->first()->name}}, 
                @endforeach</td>
                <td><form action="/teacher/group/{{$group->id}}/remove" method="post">
                  @csrf
                  @method('DELETE')
