...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <h3 class="text-center mt-3">{{$lab->lab_name}}</h3>
        <div class="card text-center">
            <div class="card-body">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                  <a href="/teacher/lab/{{$lab->id}}/alert"><button class="btn btn-danger me-md-2 btn-sm" type="button">Send Alert Question</button></a>
                </div>
              <h5 class="card-title">{{$lab->task_name}}</h5>
        ...
        <div class="row">
            <div class="col-6">
                <ol class="list-group list-group-numbered mt-3">
                  @foreach(App\Models\labstudents::where('lab_id', $lab->id)->get() as $students)
                    <li class="list-group-item d-flex justify-content-between align-items-start">
                      <div class="ms-2 me-auto">
                        <div class="fw-bold">{{$students->student->name}}</div>
                        Joined: {{$students->student->created_at->diffForHumans()}}
                      </div>
            ...
            <div class="col-6">
                ...
                <div class="card m-3">
                    <div class="card-body">
                      <ul>
                        @foreach(App\Models\chat::where('lab_id', $lab->id)->get() as $chat)
                      ...
                      <form action="/teacherchat" method="POST">
                        @csrf
                        <div class="input-group mb-3">
                            ...
                            <input type="text" style="display: none;" name="group" value="teacher" />
