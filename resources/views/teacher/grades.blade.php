...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <h3 class="text-center mt-3">Usman's Solution</h3>
        ...
        <div class="input-group flex-nowrap m-2">
            ...
            <input type="text" class="form-control" placeholder="E.g A+" aria-label="Username" aria-describedby="addon-wrapping">
        </div>
        <a href="/teacher/labs/manage"><button class="btn btn-sm btn-success m-2">Add Grade</button></a>
        </div>
    </main>
  </div>
</div>
